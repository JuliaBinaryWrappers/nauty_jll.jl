# Autogenerated wrapper script for nauty_jll for x86_64-apple-darwin14
...
const libnauty_splitpath = ["lib", "libnauty.2.dylib"]
...
const libnauty = "@rpath/libnauty.2.dylib"
...
const libnautyS1_splitpath = ["lib", "libnautyS1.2.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libnautyS1 = "@rpath/libnautyS1.2.dylib"
...
const libnautyW0_splitpath = ["lib", "libnautyW0.2.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libnautyW0 = "@rpath/libnautyW0.2.dylib"
...
const libnautyS0_splitpath = ["lib", "libnautyS0.2.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libnautyS0 = "@rpath/libnautyS0.2.dylib"
...
const libnautyA1_splitpath = ["lib", "libnautyA1.2.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libnautyA1 = "@rpath/libnautyA1.2.dylib"
...
const libnautyL1_splitpath = ["lib", "libnautyL1.2.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libnautyL1 = "@rpath/libnautyL1.2.dylib"
...
const libnautyL0_splitpath = ["lib", "libnautyL0.2.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libnautyL0 = "@rpath/libnautyL0.2.dylib"
...
const libnautyW1_splitpath = ["lib", "libnautyW1.2.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libnautyW1 = "@rpath/libnautyW1.2.dylib"
