...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import nauty_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("55c6dc9b-343a-50ca-8ff2-b71adb3733d5"))
platforms = [Pkg.Artifacts.unpack_platform(e, "nauty", artifacts_toml) for e in artifacts["nauty"]]
...
if best_platform === nothing
    @debug("Unable to load nauty; unsupported platform $(triplet(platform_key_abi()))")
else
